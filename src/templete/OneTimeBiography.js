        ...
        <div className="w-full max-w-2xl text-center bg-white bg-opacity-20 backdrop-blur-lg p-6 sm:p-10 rounded-lg shadow-2xl">
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="bg-white text-purple-600 font-semibold px-4 py-2 sm:px-6 sm:py-3 rounded-full shadow-lg hover:bg-purple-600 hover:text-green-600 transition duration-300 transform hover:scale-105"
            >
